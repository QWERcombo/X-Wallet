...
- (instancetype)dh_initWithFrame:(CGRect)frame imageNameArray:(NSArray<NSString *> *)imageNameArray buttonIsHidden:(BOOL)isHidden {
    if ([super initWithFrame:frame]) {
        ...
        [skipButton setTitle:AppLanguageStringWithKey(AppLanguageStringWithKey(@"跳过")) forState:UIControlStateNormal];
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                [startButton setTitle:AppLanguageStringWithKey(AppLanguageStringWithKey(@"开始体验")) forState:UIControlStateNormal];
...
- (instancetype)dh_initWithFrame:(CGRect)frame videoURL:(NSURL *)videoURL {
    if ([super initWithFrame:frame]) {
        ...
        [movieStartButton setTitle:AppLanguageStringWithKey(AppLanguageStringWithKey(@"开始体验")) forState:UIControlStateNormal];
