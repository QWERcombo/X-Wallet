...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *imagePath = @"";
    if ([self.imgArr[itemIndex] isKindOfClass:[NSDictionary class]]) {
        imagePath = self.imgArr[itemIndex][@"cover"];
    } else if ([self.imgArr[itemIndex] isKindOfClass:[NSString class]]) {
        imagePath = self.imgArr[itemIndex];
    }
    ...
    cell.layer.cornerRadius = self.imgCornerRadius;
